...
write_rds(od21, file = here("data/created/download_gps_data/ornitela_data_2021_version2026-01-19.RDS"))
write_rds(od22, file = here("data/created/download_gps_data/ornitela_data_2022_version2026-01-19.RDS"))
write_rds(id21, file = here("data/created/download_gps_data/inpa_data_2021_version2026-01-19.RDS"))
write_rds(id22, file = here("data/created/download_gps_data/inpa_data_2022_version2026-01-19.RDS"))
